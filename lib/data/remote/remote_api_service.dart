...
/// Remote API service for handling all HTTP calls to JSONPlaceholder
/// 
/// This service is responsible ONLY for HTTP communication.
/// Business logic regarding data source selection (API vs local storage)
/// should be handled by the Repository layer.
/// 
